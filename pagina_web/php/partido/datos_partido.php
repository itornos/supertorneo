...
<link rel="stylesheet" href="../../css/buscador_partido.css" media="screen">
    <script class="u-script" type="text/javascript" src="../../js/jquery.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="../../js/nicepage.js" defer=""></script>
    <script src="../../js/jquery-3.4.1.min.js"></script>
	  <script src="../../js/bootstrap.min.js"></script>
	  <script src="../../js/buscar_partido.js"></script>
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-206f"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-grey-5 u-section-1" id="sec-c374">
      ...
      <h1 class="u-text u-text-default u-text-1" id="ala">Buscar Partido</h1>
        <div class="u-form u-form-1">
          <form action="buscador_partidos.php" method="POST" class="u-clearfix u-form-spacing-10  u-inner-form" style="padding: 10px;" source="email" name="form-3">
            <div class="u-form-group u-form-name u-label-none">
              <label for="name-5485" class="u-label"></label>
        ...
        <div class="u-clearfix u-sheet u-valign-middle-xs u-sheet-1">
            ...
            <div class="u-container-style u-group u-shape-rectangle u-group-1">
                <div class="u-container-layout u-container-layout-1">
                    <img src="../../imagenes_equipos_jugadores/<?php echo $mostrar['local'] ?>.png" alt="" class="u-expanded-height u-image u-image-contain u-image-default u-image-2" data-image-width="354" data-image-height="354">
                </div>
            </div>
            <h1 class="u-text u-text-3"><?php echo strtoupper($mostrar['local']) ?></h1>
            <h1 class="u-text u-text-4"><?php echo strtoupper($mostrar['visitante']) ?></h1>
            <div class="u-list u-list-1">
                <div class="u-repeater u-repeater-1">
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-2"><span class="u-file-icon u-icon u-spacing-16 u-icon-1"><img src="../../images/2726007.png" alt=""></span><span class="u-file-icon u-icon u-spacing-16 u-icon-2"><img src="../../images/2726007.png" alt=""></span>
                            <h4 class="u-text u-text-5">GOLES</h4>
                        </div>
                    </div>
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-3"><span class="u-file-icon u-icon u-spacing-16 u-icon-3"><img src="../../images/1071132.png" alt=""></span><span class="u-file-icon u-icon u-spacing-16 u-icon-4"><img src="../../images/1071132.png" alt=""></span>
                            <h4 class="u-text u-text-6">TIROS</h4>
                        </div>
                    </div>
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-4"><span class="u-file-icon u-icon u-spacing-16 u-icon-5"><img src="../../images/43472.png" alt=""></span><span class="u-file-icon u-icon u-spacing-16 u-icon-6"><img src="../../images/43472.png" alt=""></span>
                            <h4 class="u-text u-text-7">PASES</h4>
                        </div>
                    </div>
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-5"><span class="u-file-icon u-icon u-spacing-16 u-icon-7"><img src="../../images/98913.png" alt=""></span><span class="u-file-icon u-icon u-spacing-16 u-icon-8"><img src="../../images/98913.png" alt=""></span>
                            <h4 class="u-text u-text-8">POSESION</h4>
                        </div>
                    </div>
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-6"><span class="u-file-icon u-icon u-spacing-16 u-icon-9"><img src="../../images/419952.png" alt=""></span><span class="u-file-icon u-icon u-spacing-16 u-icon-10"><img src="../../images/419952.png" alt=""></span>
                            <h4 class="u-text u-text-9">PARTIDO DE</h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-e88d">
