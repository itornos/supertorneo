...
public class Menus {
	...
	public void menuPrincipalOrganizador(){
        System.out.println("MENU");
			System.out.println("----------------------");
			System.out.println("1_ Jugadores");
			System.out.println("2_ Arbitros");
			...
			System.out.println("4_ Clasificaion");
			System.out.println("5_ Partidos");
			System.out.println("6_ Cerra sesion");
            System.out.println("7_ Alt + f4");
    }


	public void menuPrincipalUsuario(){
        System.out.println("MENU");
			System.out.println("----------------------");
			System.out.println("1_ Jugadores");
			System.out.println("2_ Arbitros");
	...
	public void menuJAUsusario(){
        System.out.println("  ______________________  ");
        System.out.println("||                      ||");
        System.out.println("||  Que desea hacer...  ||");
        System.out.println("||----------------------||");
        System.out.println("||  1_Ver persona       ||");
	...
	public void menuEUsuario(){
        System.out.println("  ______________________  ");
        System.out.println("||                      ||");
        System.out.println("||  Que desea hacer...  ||");
        System.out.println("||----------------------||");
        System.out.println("||  1_Ver Equipo        ||");
        System.out.println("||  2_Salir             ||");
        System.out.println("||______________________||");
    }
    ...
    public void menuAdmin() throws IOException{
		...
		while(bucleMain) {
			...
			switch(opcion) {
						...
						switch(opcion) {
							...
							case 3:
								if(Clasificacion.sorteo && Registro.partidos.size()==(Clasificacion.numeroEquipos*3)*2){
									...
									System.out.println("Todavia no se ha realizado el sorteo o la fase de grupos no ha terminado");
								}							
								break;
							case 4:
								break;
				...
				default:
					System.out.println("debes dar un numero entre 1 y 8");
					break;
			}
		}
    }
	...
	public void menuOrganizador() throws IOException{
		...
		while(bucleMain) {
			...
			menus.menuPrincipalOrganizador();
			opcion= Auxiliar.registroNumero();
			System.out.println();
			...
			switch(opcion) {
				...
				default:
					System.out.println("debes dar un numero entre 1 y 7");
					break;
			}
		}
    }
