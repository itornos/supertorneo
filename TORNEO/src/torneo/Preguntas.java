...
public class Preguntas {
	...
	public void preguntasPartidoAutomatico(){
		...
		Registro.clubs.get(idclubv).difgoles=Registro.clubs.get(idclubv).golesfavor-Registro.clubs.get(idclubv).golescontra;
		Registro.clubs.get(idclubl).difgoles=Registro.clubs.get(idclubl).golesfavor-Registro.clubs.get(idclubl).golescontra;
