...
public class Iniciar extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {                                         
        ...
        registroSQL(jTextField1.getText(), pass);
    }
    
    private void registroSQL(String usu, String pass) throws SQLException {
		...
		try {
			...
			while (rs.next()) {
				if(rs.getString("usuario").equals(usu.toString()) && rs.getString("PASSWORD").equals(pass.toString())) {
                    ...
                    switch(rs.getString("rol")){
	                    case "admin": 
                            java.awt.EventQueue.invokeLater(new Runnable() {
                                public void run() {
                                    MenuAdmin iniciar = new MenuAdmin();
